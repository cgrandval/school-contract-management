...
use App\Service\ContractNumberGenerator;
...
class ContractController extends AbstractController
{
     ...
     */
    public function new(Request $request, ContractNumberGenerator $contractNumberGenerator): Response
    {
        $contract = new Contract();
        $contract->setNumber($contractNumberGenerator->generateNumber());
